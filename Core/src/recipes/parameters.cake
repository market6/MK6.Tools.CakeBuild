public class BuildParameters
{
        ...
        )
    {
        ...
        return new BuildParameters {
            ...
            //IsMainRepository = true,//StringComparer.OrdinalIgnoreCase.Equals(string.Concat(repositoryOwner, "/", repositoryName), buildSystem.AppVeyor.Environment.Repository.Name),
